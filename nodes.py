    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "image": ("IMAGE",),
                "model": (["doubao-seedance-1-0-lite-i2v-250428", "doubao-seedance-1-0-pro-250528", "wan2-1-14b-i2v-250225", "doubao-seaweed-241128"], {"default": "doubao-seedance-1-0-lite-i2v-250428"}),
